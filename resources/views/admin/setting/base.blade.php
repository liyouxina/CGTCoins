                         ...
                         <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="CANCEL_DEPOSIT_ORDER_COST" autocomplete="off" class="layui-input"
                                       value="@if(isset($setting['CANCEL_DEPOSIT_ORDER_COST'])){{$setting['CANCEL_DEPOSIT_ORDER_COST'] ?? ''}}@endif">
                            </div>
                        </div> 
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="ADMIN_KEFU" autocomplete="off" class="layui-input"
                                       value="@if(isset($setting['ADMIN_KEFU'])){{$setting['ADMIN_KEFU']}}@endif">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="LOGIN_URL" autocomplete="off" class="layui-input"
                                       value="@if(isset($setting['LOGIN_URL'])){{$setting['LOGIN_URL']}}@endif">
                            </div>
                        </div>
                        <!--<div class="layui-form-item">-->
