(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-market-market"], {
    ...
    "316d": function(i, t, e) {
        var s = e("bacd");
        "string" === typeof s && (s = [[i.i, s, ""]]),
        s.locals && (i.exports = s.locals);
    ...
    "7d9d": function(i, t, e) {
        ...
        var a = function() {
            ...
            return s("v-uni-view", {
                ...
                staticClass: "bgHeader pb10 pb5 plr20 flex alcenter bdb1f"
            }, i._l(i.marketLists, (function(t, e) {
                    return s("v-uni-view", {
                        key: e,
                        staticClass: "pt10 pb5 ft16 bold mr20 posRelt",
                        class: {
                            blue2: i.isActive == e
                        },
                        on: {
                            click: function(s) {
                                arguments[0] = s = i.$handleEvent(s),
                                    i.changeTab(e, t.name)
                            }
                        }
                    }, [i.isActive == e ? s("v-uni-image", {
                        staticClass: "myline",
                        attrs: {
                            src: "/static/line_blue.png"
                        }
                    }) : i._e(), i._v(i._s(t.name))], 1)
                }
            )), 1), s("v-uni-view", {
                staticClass: "plr10 "
            }, [s("v-uni-view", {
                staticClass: "flex alcenter ft12 blue3 ptb10"
            }, [s("v-uni-view", {
                ...
                on: {
                    click: function(t) {
                        arguments[0] = t = i.$handleEvent(t),
                            i.tapFilters(1, "currency_name")
                    }
                }
            }, [s("v-uni-text", {
                staticClass: "pr5"
            }, [i._v(i._s(i.$t("home.name")))]), s("v-uni-view", {}, [0 == i.isfilter1 ? s("v-uni-image", {
                staticClass: "wt8 h10",
                attrs: {
                    src: e("47d4")
                }
            }) : 1 == i.isfilter1 ? s("v-uni-image", {
                staticClass: "wt8 h10",
                attrs: {
                    src: e("5981")
                }
                ...
                on: {
                    click: function(t) {
                        arguments[0] = t = i.$handleEvent(t),
                            i.tapFilters(2, "now_price")
                    }
                }
            }, [s("v-uni-text", {
                staticClass: "pr5"
            }, [i._v(i._s(i.$t("home.new_price")))]), s("v-uni-view", {}, [0 == i.isfilter2 ? s("v-uni-image", {
                staticClass: "wt8 h10",
                attrs: {
                    src: e("47d4")
                }
            }) : 1 == i.isfilter2 ? s("v-uni-image", {
                staticClass: "wt8 h10",
                attrs: {
                    src: e("5981")
                }
                ...
                staticClass: "wt70 flex alcenter jsend"
            }, [s("v-uni-view", {
                staticClass: "flex alcenter",
                on: {
                    click: function(t) {
                        arguments[0] = t = i.$handleEvent(t),
                            i.tapFilters(3, "change")
                    }
                }
            }, [s("v-uni-text", {
                staticClass: "pr5"
            }, [i._v(i._s(i.$t("home.fu")))]), s("v-uni-view", {}, [0 == i.isfilter3 ? s("v-uni-image", {
                staticClass: "wt8 h10",
                attrs: {
                    src: e("47d4")
                }
            }) : 1 == i.isfilter3 ? s("v-uni-image", {
                staticClass: "wt8 h10",
                attrs: {
                    src: e("5981")
                }
                ...
                attrs: {
            ...
            })], 1)], 1)], 1)], 1), i._l(i.marketLists[i.isActive].quotation, (function(t, e) {
                    return i.marketLists[i.isActive] ? s("v-uni-navigator", {
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                            value: i.marketLists && i.marketLists[i.isActive],
                            expression: "marketLists&&marketLists[isActive]"
                        }],
                        key: e,
                        staticClass: "mb10 flex alcenter bdb1f ptb10",
                        attrs: {
                    ...
                    }, [s("v-uni-view", [s("v-uni-text", {
                        staticClass: "ft14 bold"
                    }, [i._v(i._s(t.currency_name))]), s("v-uni-text", {
                        staticClass: "ft12 blue pl5"
                    }, [i._v("/" + i._s(t.legal_name))])], 1), s("v-uni-view", {
                        staticClass: "gray9 blue pt5 ft12"
                    }, [i._v(i._s(i.$t("market.volume")) + " " + i._s(i._f("toFixed4")(t.volume)))])], 1), s("v-uni-view", {
                        staticClass: "flex1"
                    }, [s("v-uni-view", {}, [s("v-uni-text", {
                        staticClass: "ft14 bold"
                    }, [i._v(i._s(i._f("toFixed2")(t.now_price)))])], 1)], 1), s("v-uni-view", {
                        staticClass: "wt70"
                    }, [s("v-uni-view", {
                        staticClass: "tc h30 lh30 white wt70 radius2",
                        class: ["-" == t.change.substr(0, 1) ? "bgRed" : "bgGreen"]
                    }, [i._v(i._s("-" == t.change.substr(0, 1) ? "" : "+") + i._s(i._f("toFixed2")(t.change - 0)) + "%")])], 1)], 1) : i._e()
                }
            ))], 2)], 1)
        }
            , n = []
    ...
    bacd: function(i, t, e) {
        var s = e("24fb");
        t = s(!1),
            t.push([i.i, "uni-page-body[data-v-635b1788]{background:#102030}body.?%PAGE?%[data-v-635b1788]{background:#102030}", ""]),
            i.exports = t
    },
    d00b: function(i, t) {
    ...
    d05e: function(i, t, e) {
        ...
        var a = s(e("5530"))
                ...
                uni.setNavigationBarTitle({
                    ...
                    this.$utils.initDataToken({
                        url: "user/info"
                            ...
                            var e = i.$socketio(i.$socket_api);
                            e.emit("login", t.id),
                                e.on("daymarket", (function(t) {
                                        if (t.legal_name == i.legal_name) {
                                            var e = i.marketLists[i.isActive].quotation;
                                            for (var s in e)
                                                e[s].currency_name == t.currency_name && e[s].legal_name == t.legal_name && (e[s].volume = t.volume - 0,
                                                    e[s].now_price = t.now_price - 0,
                                                    e[s].change = t.change)
                                        }
                                    }
                                ))
            ...
            methods: {
                filterList: function(i, t) {
                    this.marketLists[this.isActive].quotation.sort((function(e, s) {
                            return "currency_name" == i ? 1 == t ? e[i].charCodeAt(0) - s[i].charCodeAt(0) : s[i].charCodeAt(0) - e[i].charCodeAt(0) : 1 == t ? e[i] - s[i] : s[i] - e[i]
                        }
                    ))
                },
                tapFilters: function(i, t) {
                    console.log(i, t),
                    1 == i && (this.isfilter2 = 0,
                        this.isfilter3 = 0,
                        this.isfilter1 = 1 == this.isfilter1 ? 2 : 1,
                        this.filterList(t, this.isfilter1)),
                    2 == i && (this.isfilter1 = 0,
                        this.isfilter3 = 0,
                        this.isfilter2 = 1 == this.isfilter2 ? 2 : 1,
                        this.filterList(t, this.isfilter2)),
                    3 == i && (this.isfilter2 = 0,
                        this.isfilter1 = 0,
                        this.isfilter3 = 1 == this.isfilter3 ? 2 : 1,
                        this.filterList(t, this.isfilter3))
                },
                getList: function() {
                    var i = this;
                    this.$utils.initData({
                        url: "currency/quotation_new"
                            ...
                            uni.stopPullDownRefresh(),
                                i.marketLists = t,
                            t.length > 0 && (i.legal_name = t[0].name)
                        }
                    ))
                },
                changeTab: function(i, t) {
                    this.isfilter3 = 0,
                        this.isfilter2 = 0,
                        this.isfilter1 = 0,
                        this.isActive = i,
