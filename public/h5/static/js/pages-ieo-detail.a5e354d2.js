(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-ieo-detail"], {
    1546: function(t, i, a) {
        "use strict";
        a.r(i);
        var e = a("2616")
        ...
        var n = e(a("5530"))
            ...
            methods: {
                ...
                inputAmount: function() {
                    1 * this.amount < 0 || (this.compute_price = this.amount * this.detail.price)
                },
                inputPsAmount: function() {
                    1 * this.psAmount < 0 || (this.compute_ps_price = this.psAmount * this.detail.price)
                },
                submitPs: function() {
                    var t = this;
                    t.psAmount < 0 ? t.$utils.showLayer(t.$t("trade.p_num")) : this.$utils.initDataToken({
                        url: "project/buy",
                        type: "post",
                        data: {
                            total_price: t.psAmount,
                            project_id: t.detail.id
                        }
                    }, (function(i) {
                            uni.hideLoading(),
                                t.$utils.showLayer(i.msg),
                            "ok" == i.type && (t.psAmount = "",
                                t.bool = !1)
                        }
                    ))
                },
                submitrg: function() {
                    var t = this;
                    if (t.amount < 0)
                        t.$utils.showLayer(t.$t("trade.p_num"));
                    else {
                        uni.showLoading();
                        var i = "";
                        var i = "project/order";
                ...
                init: function(t) {
                    ...
                    this.$utils.initDataToken({
                        ...
                        data: {
                            ...
                            if (i.detail = t.info,
                                i.orderInfo = t.order_info,
                                i.detail.start_at = i.detail.start_at.split(" ")[0],
                                i.detail.end_at = i.detail.end_at.split(" ")[0],
                                i.detail.sell_begin = i.detail.sell_begin.split(" ")[0],
                                i.detail.sell_begin) {
                                var a = (new Date).getTime();
                                new Date(i.detail.sell_begin).getTime() - a < 0 && (i.psstatus = 1),
                                    1 == i.detail.user_has_money ? i.sgtxt = i.$t("zdy.sg") : i.sgtxt = i.$t("zdy.cyyh")
                            }
                        }
                    ))
                }
    ...
    "79ae": function(t, i, a) {
        ...
        var n = function() {
            var t = this
                , i = t.$createElement
                , a = t._self._c || i;
            return a("v-uni-view", [a("v-uni-navigator", {
                staticClass: "back mt5",
                attrs: {
            ...
            })], 1), t.bool ? a("v-uni-view", {
                staticClass: "rgcz"
            }, [a("v-uni-view", {
                staticClass: "rgcz-mask",
                on: {
                    click: function(i) {
            ...
            }), 1 == t.detail.time_status || 2 == t.detail.time_status ? a("v-uni-view", {
                staticClass: "rgcz-content"
            }, [a("v-uni-view", {
                staticClass: "rgcz-title"
            }, [t._v(t._s(t.sgtxt))]), a("v-uni-view", {
                staticClass: "rgcz-input"
            }, [a("v-uni-input", {
                attrs: {
                    type: "number",
                    placeholder: t.$t("zdy.srrgsl")
                },
                on: {
                    input: function(i) {
                        arguments[0] = i = t.$handleEvent(i),
                ...
                staticClass: "rgcz-currency"
            }, [t._v("1 " + t._s(t.detail.currency_name) + " = " + t._s(t.detail.price) + " " + t._s(t.detail.pay_currency_name))]), a("v-uni-view", {
                staticClass: "rg-ptb"
            }, [t._v(t._s(t.$t("zdy.kdh")) + t._s(t.detail.pay_currency_name) + "：" + t._s(t._f("toFixed8")(t.compute_price)))]), a("v-uni-view", {
                staticClass: "rg-submit",
                on: {
                    click: function(i) {
                        arguments[0] = i = t.$handleEvent(i),
                            t.submitrg()
            ...
            }, [t._v(t._s(t.sgtxt))])], 1) : t._e(), 3 == t.detail.time_status ? a("v-uni-view", {
                staticClass: "rgcz-content"
            }, [a("v-uni-view", {
                staticClass: "rgcz-title"
            }, [t._v(t._s(t.$t("zdy.peishou")))]), a("v-uni-view", {
                staticClass: "rgcz-input",
                staticStyle: {
                    margin: "50upx 0"
                }
            ...
            }, [t._v(t._s(t.$t("login.e_confrim2")))])], 1) : t._e()], 1) : t._e(), a("v-uni-view", {
                staticClass: "top-bg"
            }, [a("v-uni-view", {
                staticClass: "top-title"
            }, [a("v-uni-view", {
                staticClass: "top-title-h1"
            }, [t._v(t._s(t.detail.title))]), a("v-uni-text", [t._v(t._s(t.detail.summary))])], 1)], 1), a("v-uni-view", {
                staticClass: "white-jje"
            }, [a("v-uni-view", {
                staticClass: "white-time"
            }, [a("v-uni-view", {
                staticClass: "white-time-h1"
            }, [t._v(t._s(t.$t("zdy.jssj")))]), a("v-uni-text", [t._v(t._s(t.detail.end_at))])], 1), a("v-uni-view", {
                staticClass: "white-time between"
            }, [a("v-uni-view", {
                staticClass: "white-time-h2"
            }, [t._v(t._s(t.$t("zdy.fhjg")))]), a("v-uni-text", [t._v("1 " + t._s(t.detail.currency_name) + " = " + t._s(t.detail.price) + " " + t._s(t.detail.pay_currency_name))])], 1), a("v-uni-view", {
                staticClass: "white-time between"
            }, [a("v-uni-view", {
                staticClass: "white-time-h2"
            }, [t._v(t._s(t.$t("zdy.fhzl")))]), a("v-uni-text", [t._v(t._s(t.detail.amount) + " " + t._s(t.detail.currency_name))])], 1), a("v-uni-view", {
            ...
            }, [t._v(t._s(t.$t("zdy.gw")))]), a("v-uni-navigator", {
                attrs: {
                    url: t.detail.white_book,
                    target: "_blank"
                }
            }, [t._v(t._s(t.$t("zdy.bps")))])], 1)], 1), t.orderInfo ? a("v-uni-view", {
                staticClass: "result"
            }, [a("v-uni-view", {
                staticClass: "sgzq-title"
            }, [t._v(t._s(t.$t("zdy.ztcpjg")))]), a("v-uni-view", {
                staticClass: "rg-view"
            }, [a("v-uni-text", [t._v(t._s(t.$t("zdy.zjcpzs")) + "：")]), a("v-uni-text", [t._v(t._s(t.detail.total_apply))])], 1), a("v-uni-view", {
                staticClass: "rg-view"
            }, [a("v-uni-text", [t._v(t._s(t.$t("zdy.zjcpbfb")) + "：")]), a("v-uni-text", [t._v(t._s(t.detail.win_rate))])], 1), a("v-uni-view", {
                staticClass: "sgzq-title",
                staticStyle: {
                    "margin-top": "30upx"
                }
            }, [t._v(t._s(t.$t("zdy.ndcpjg")))]), a("v-uni-view", {
                staticClass: "rg-id"
            }, [t._v(t._s(t.$t("zdy.zjddh")) + "：" + t._s(t.orderInfo.order_no))]), 2 == t.orderInfo.type && 1 == t.orderInfo.status ? a("v-uni-view", {
                staticClass: "rg-tips"
            }, [a("v-uni-view", {
                staticClass: "rg-tips0"
            }, [t._v(t._s(t.$t("zdy.rgsl")) + "：" + t._s(t.orderInfo.coin_amount) + t._s(t.detail.currency_name))]), a("v-uni-view", {
                staticClass: "rg-tips0"
            }, [t._v(t._s(t.$t("zdy.qbczhye")) + "：" + t._s(t.orderInfo.total_price) + t._s(t.detail.pay_currency_name))])], 1) : t._e(), 3 == t.orderInfo.status ? a("v-uni-view", {
                staticClass: "rg-tips"
            }, [a("v-uni-view", {
                staticClass: "rg-tips0"
            }, [t._v(t._s(t.$t("zdy.rgsl")) + "：" + t._s(t.$t("trade.has_done")))])], 1) : t._e()], 1) : t._e(), a("v-uni-view", {
                staticClass: "sgzq"
            }, [a("v-uni-view", {
                staticClass: "sgzq-title"
            }, [t._v(t._s(t.$t("zdy.sgzq")))]), a("v-uni-view", {
                staticClass: "sc-1hdolm6-1 hFymFN"
            }, [a("v-uni-view", {
                staticClass: "item active",
                class: {
                    "item-circle-active": 1 == t.detail.time_status
                }
            }, [a("v-uni-text", {
                staticClass: "item-circle"
            }, [t._v("1")]), a("v-uni-view", {
                staticClass: "item-title"
            }, [t._v(t._s(t.$t("zdy.yr"))), a("v-uni-view", {
                staticClass: "time"
            })], 1)], 1), a("v-uni-view", {
                staticClass: "item active"
            }, [a("v-uni-text", {
                ...
                staticClass: "item-title"
            }, [t._v(t._s(t.$t("zdy.sg"))), a("v-uni-view", {
                staticClass: "time"
            }, [t._v(t._s(t.detail.start_at))])], 1)], 1), a("v-uni-view", {
                staticClass: "item active"
            }, [a("v-uni-text", {
                staticClass: "item-circle",
                class: {
                    "item-circle-active": 1 == t.detail.time_status || 2 == t.detail.time_status
                }
            }, [t._v("3")]), a("v-uni-view", {
                staticClass: "item-title"
            }, [t._v(t._s(t.$t("zdy.yaohao"))), a("v-uni-view", {
                staticClass: "time"
            }, [t._v(t._s(t.detail.end_at))])], 1)], 1), a("v-uni-view", {
                staticClass: "item active"
            }, [a("v-uni-text", {
                staticClass: "item-circle",
                class: {
                ...
                staticClass: "item-title"
            }, [t._v(t._s(t.$t("zdy.js"))), a("v-uni-view", {
                staticClass: "time"
            }, [t._v(t._s(t.detail.end_at))])], 1)], 1), t.psstatus ? a("v-uni-view", {
                staticClass: "item active"
            }, [a("v-uni-text", {
                staticClass: "item-circle",
                class: {
                ...
                staticClass: "time"
            }, [t._v(t._s(t.detail.sell_begin))])], 1)], 1) : t._e()], 1)], 1), a("v-uni-view", {
                staticClass: "xmxq"
            }, [a("v-uni-view", {
                staticClass: "xmxq-title"
            }, [t._v(t._s(t.$t("zdy.xmxq")))]), a("v-uni-view", {
                staticClass: "xmxq-content",
                domProps: {
                    innerHTML: t._s(t.detail.content)
                }
            })], 1), a("v-uni-view", {
                staticStyle: {
                    height: "60px",
            ...
            }, [t._v(t._s(t.$t("login.login")))]), 2 == t.detail.time_status && t.token ? a("v-uni-button", {
                on: {
                    click: function(i) {
                        arguments[0] = i = t.$handleEvent(i),
                            t.submit()
            ...
            }, [t._v(t._s(t.$t("zdy.sg")))]) : t._e(), 1 == t.detail.time_status && t.token ? a("v-uni-button", {
                staticStyle: {
                    background: "#999"
                }
            }, [t._v(t._s(t.$t("zdy.wks")))]) : t._e()], 1) : t._e(), 3 == t.detail.time_status ? a("v-uni-view", {
                staticClass: "submit"
            }, [t.token ? t._e() : a("v-uni-button", {
                on: {
                    click: function(i) {
            ...
            }, [t._v(t._s(t.$t("login.login")))]), t.token && t.psstatus ? a("v-uni-button", {
                on: {
                    click: function(i) {
                        arguments[0] = i = t.$handleEvent(i),
                            t.submit()
            ...
            }, [t._v(t._s(t.$t("zdy.peishou")))]) : t._e(), t.token && !t.psstatus ? a("v-uni-button", {
                on: {
                    click: function(i) {
                        arguments[0] = i = t.$handleEvent(i),
                            t.submit()
            ...
            }, [t._v(t._s(t.$t("zdy.yjs")))]) : t._e()], 1) : t._e()], 1)
        }
            , s = []
    },
    f91b: function(t, i, a) {
