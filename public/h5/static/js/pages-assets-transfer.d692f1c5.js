(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-assets-transfer"], {
    4610: function(t, e, a) {
        "use strict";
        a.r(e);
        var n = a("e8f5")
        ...
        a("c4a2");
        var c, l = a("f0c5"), r = Object(l["a"])(s["default"], n["b"], n["c"], !1, null, "228c5df2", null, !1, n["a"], c);
        e["default"] = r.exports
    },
    "77c4": function(t, e, a) {
        var n = a("24fb");
        e = n(!1),
        e.push([t.i, ".animateUp[data-v-228c5df2]{-webkit-transform:translateY(%?-80?%);transform:translateY(%?-80?%);-webkit-transition:all .5s;transition:all .5s}.animateDown[data-v-228c5df2]{-webkit-transform:translateY(%?80?%);transform:translateY(%?80?%);-webkit-transition:all .5s;transition:all .5s}.animateOff[data-v-228c5df2]{-webkit-transform:translateY(0);transform:translateY(0);-webkit-transition:all .5s;transition:all .5s}", ""]),
        t.exports = e
    },
    7980: function(t, e, a) {
        var n = a("77c4");
          ...
          , c = {
            data: function() {
                return {
                    ...
                    name: "",
                    coinInfo: {},
                    changeName: [this.$t("assets.tradeacc"), this.$t("assets.leveracc")],
                    changeType: ["change", "lever"],
                    type: 0,
                    hasChange: 0,
                    animateTab1: "",
                    animateTab2: "",
                    ...
                    tabList: [{
                        name: "change",
                        value: this.$t("assets.tradeacc")
                    }, {
                        name: "lever",
                        value: this.$t("assets.leveracc")
                    },{
                        name: "micro",
                        value: this.$t("assets.microacc")
                    }]
                }
            },
            onLoad: function(t) {
            ...
            methods: {
                changeOne: function() {
                    ...
                    uni.showActionSheet({
                        ...
                        success: function(e) {
                            t.changeName[0] = t.tabList[e.tapIndex].value,
                            t.tabIndex = t.tabList[e.tapIndex].name,
                            t.$forceUpdate(),
                            t.getBalance(t.tabIndex)
                        }
                    })
                },
                changeTwo: function() {
                    ...
                    uni.showActionSheet({
                        itemList: [this.$t("assets.tradeacc"), this.$t("assets.leveracc"), this.$t("assets.microacc")],
                        success: function(e) {
                            t.changeName[1] = t.tabList[e.tapIndex].value,
                            t.tabIndexTwo = t.tabList[e.tapIndex].name,
                            t.$forceUpdate()
                        }
                    })
                },
                getBalance: function(t) {
                    ...
                    this.$utils.initDataToken({
                        ...
                        "change" == t && (e.balance = a.change_balance),
                        "lever" == t && (e.balance = a.lever_balance),
                        "micro" == t && (e.balance = a.micro_balance),
                        "legal" == t && (e.balance = a.legal_balance)
                    }
                    ))
                },
                getList: function() {
                    ...
                    this.$utils.initDataToken({
                        ...
                        var a = e.change_wallet.balance
                          , n = a.filter((function(e) {
                            return e.currency_name == t.name
                        }
                        )) || [];
                        n.length > 0 && (t.currencyLegal = n[0],
                        0 == t.type && (t.balance = n[0].change_balance),
                        t.wallet_id = n[0].currency)
                    }
                    ))
                },
                tapChange: function() {
                ...
                transfer: function() {
                    var t = this;
                    if (this.tabIndex != this.tabIndexTwo)
                        return this.number ? void this.$utils.initDataToken({
                            url: "wallet/change",
                            type: "POST",
                            data: {
                        ...
                        )) : this.$utils.showLayer(this.$t("assets.p_transfernum"))
                }
            }
        };
        e.default = c
    ...
    e8f5: function(t, e, a) {
        ...
        var s = function() {
            ...
            return n("v-uni-view", {
                ...
                staticClass: "plr15 ptb30 bgPart"
            }, [n("v-uni-view", {
                staticClass: " flex alcenter between bd2f"
            }, [n("v-uni-view", {
                staticClass: "flex alcenter pl15 flex1"
            }, [n("v-uni-view", {
                staticClass: "flex column alcenter "
            }, [n("v-uni-text", {
                staticClass: "wt5 h5 radius50p bgBlue"
            }), n("v-uni-view", {
                staticClass: "h20 mt5 mb5 bdl2f"
            }), n("v-uni-text", {
                staticClass: "wt5 h5 radius50p bgred"
            })], 1), n("v-uni-view", {
                staticClass: "ml10 flex1"
            }, [n("v-uni-view", {
                staticClass: "h40 lh40 bdb2f flex alcenter",
                on: {
                    click: function(e) {
                        arguments[0] = e = t.$handleEvent(e),
                        t.changeOne.apply(void 0, arguments)
                    }
                }
            }, [n("v-uni-text", {
                staticClass: "blue pr10"
            }, [t._v(t._s(t.$t("assets.from")))]), n("v-uni-view", {
                class: [{
                    animateDown: 1 == t.type,
                    animateOff: 0 == t.type
                }]
            }, [t._v(t._s(t.changeName[0]))])], 1), n("v-uni-view", {
                staticClass: "h40 lh40 flex alcenter",
                on: {
                    click: function(e) {
                        arguments[0] = e = t.$handleEvent(e),
                        t.changeTwo.apply(void 0, arguments)
                    }
                }
            }, [n("v-uni-text", {
                staticClass: "blue pr10"
            }, [t._v(t._s(t.$t("assets.to")))]), n("v-uni-view", {
                class: [{
                    animateUp: 1 == t.type,
                    animateOff: 0 == t.type
                }]
            }, [t._v(t._s(t.changeName[1]))])], 1)], 1)], 1), n("v-uni-view", {
                staticClass: "plr15 bggray h80 flex alcenter jscenter"
            }, [n("v-uni-view", {
                staticClass: "wt30 h30 radius50p bggray flex alcenter jscenter",
                on: {
                    click: function(e) {
                        arguments[0] = e = t.$handleEvent(e),
                        t.tapChange.apply(void 0, arguments)
                    }
                }
            }, [n("v-uni-image", {
                ...
                staticClass: "mt10 plr15 bgPart pt20",
                staticStyle: {
                    "min-height": "75.0vh"
                }
            }, [n("v-uni-view", {}, [t._v(t._s(t.$t("assets.transfernum")))]), n("v-uni-view", {
                staticClass: "flex alcenter between bdb1f mt10"
            }, [n("v-uni-input", {
                staticClass: "h40 flex1",
                attrs: {
                    type: "number",
                    placeholder: t.$t("assets.p_transfernum")
                },
                model: {
                    value: t.number,
                    callback: function(e) {
            ...
            }, [t._v(t._s(t.name || "--"))]), n("v-uni-view", {
                staticClass: "pl10",
                on: {
                    click: function(e) {
                        arguments[0] = e = t.$handleEvent(e),
                        t.all.apply(void 0, arguments)
                    }
                }
            }, [t._v(t._s(t.$t("trade.all")))])], 1)], 1), n("v-uni-view", {
                staticClass: "mt10 blue ft12"
            }, [t._v(t._s(t.$t("trade.use"))), n("v-uni-text", [t._v(t._s(t.balance))]), t._v(t._s(t.name))], 1), n("v-uni-view", {
                staticClass: "mt50 bgBlue radius4 ptb10 white ft14 tc mb10",
                on: {
                    click: function(e) {
                        arguments[0] = e = t.$handleEvent(e),
                        t.transfer.apply(void 0, arguments)
                    }
                }
            }, [t._v(t._s(t.$t("assets.transfer")))])], 1)], 1)
        }
          , i = []
    }
}]);
