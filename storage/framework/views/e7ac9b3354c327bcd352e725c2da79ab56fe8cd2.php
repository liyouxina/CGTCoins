            ...
            <div class="layui-tab-content">
                ...
                <div class="layui-tab-item">
                    <div class="layui-form-item <?php echo e($result->id == 3 ? '' : 'hide'); ?>">
                        <label class="layui-form-label">充币地址omni</label>
                        <div class="layui-input-block">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" id="address_trc" name="address_trc" value="<?php echo e($result->address_trc); ?>" placeholder="地址">
                        </div>
                    </div>
                     <?php if( $result->id ==3): ?>
                    <div class="layui-form-item">
