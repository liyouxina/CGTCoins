...
<script type="text/html" id="toolbar">
    <button class="layui-btn layui-btn-xs" lay-event="update">获取私钥</button>
    </script>
<script>
            ...
            ,cols: [
                [
                    ...
                    ,{field: 'address', title: '地址', width: 380, rowspan: 2}
                     ,{field: 'address_2', title: '地址OMNI', width: 380, rowspan: 2}
                      ,{field: 'address_3', title: '地址TRC20', width: 380, rowspan: 2}
        ...
        table.on('tool(data_table)', function (obj) {
            ...
            if (layEvent === 'update') {
                var index = layer.open({
                    title: '获取私钥'
                    ,type: 2
                    ,content: '/admin/wallet/private?id=' + data.id
                    ,maxmin: true
                });
