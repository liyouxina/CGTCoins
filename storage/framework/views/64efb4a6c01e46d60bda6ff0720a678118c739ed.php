      ...
      <div class="layui-form layui-card-header layuiadmin-card-header-auto" lay-filter="layadmin-userfront-formlist">
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-inline" style="margin-left: 10px;">
            ...
            <button class="layui-btn layui-btn-primary" id="btn-set" type="button" style="padding:0px;margin-left: -4px;width: 30px;position: absolute;top: 0;right: -38px;">
              <i class="layui-icon layui-icon-set-fill" style="left: 5px;cursor: pointer;"></i>
            </button>
          </div>
          <div class="layui-inline" style="margin-left: 10px;">
...
<script src="/js/jquery-1.11.1.min.js"></script>
 ...
 <script type="text/html" id="barDemo">
        {{d.status==1 ? '<button type="button" onclick="pass('+d.id+')">设置赢</button> <button type="button" onclick="refuse('+d.id+')" data-id='+d.id+' class="btn-refuse">设置亏</button>' : '' }}
