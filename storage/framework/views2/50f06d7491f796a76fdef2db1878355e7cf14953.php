                ...
                function tbRend(url) {
                    table.render({
                        ...
                        ,cols: [[
                                ...
                                ,{field: '_change_balance', title: '币币账户', width: 150, totalRow: true}
                                  ,{field: '_lever_balance', title: '合约账户', width: 150, totalRow: true}
                                  ,{field: '_micro_balance', title: '期权账户', width: 150, totalRow: true}
                                //   ,{field: '_legal_balance', title: '法币账户', width: 150, totalRow: true}
