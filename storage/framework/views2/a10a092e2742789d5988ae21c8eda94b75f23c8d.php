            ...
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-form-item">
                     ...
                     <div class="layui-form-item">
                        <label class="layui-form-label">行情最高值</label>
                        <div class="layui-input-inline">
                            <input type="number" class="layui-input" id="price_max" name="price_max" value="<?php echo e($result->price_max); ?>" placeholder="百分比">
                        </div>
                      
                    </div>
                     <div class="layui-form-item">
                        <label class="layui-form-label">行情最低值</label>
                        <div class="layui-input-inline">
                            <input type="number" class="layui-input" id="price_min" name="price_min" value="<?php echo e($result->price_min); ?>" placeholder="百分比">
                        </div>
